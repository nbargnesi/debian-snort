...
\title{SNORT\textsuperscript{\textregistered} Users Manual\\2.9.2}
...
\item[] \texttt{ports}
\begin{itemize}
\item[]  This specifies on what ports to check for SIP messages. Typically, 
...
The recommended approach to logging is to use unified2 with barnyard2 or similar.
\end{note}
...
\begin{note}
The \texttt{alert\_prelude} output plugin is considered deprecated as of Snort 2.9.2 and
will be removed in Snort 2.9.3.
\end{note}
...
\begin{note}
The \texttt{alert\_aruba\_action} output plugin is considered deprecated as of Snort 2.9.2 and
will be removed in Snort 2.9.3.
\end{note}
